...
from transformers import CLIPTextModel, CLIPTokenizerFast, T5EncoderModel, T5TokenizerFast
import torch
import gc
...
def generate_python_scripts(directory):
    ...
    for i in range(1, num_splits + 1):
        script_content = (
            ...
            "tokenizer = CLIPTokenizerFast.from_pretrained('openai/clip-vit-large-patch14', torch_dtype=dtype)\n"
